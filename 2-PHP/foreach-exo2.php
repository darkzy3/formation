...
la variable `$compositeursItaliens` est un tableau associatif contenant une liste de couples clé / valeur de 
compositeurs italiens avec leur période de vie écire une boucle foreach qui :
